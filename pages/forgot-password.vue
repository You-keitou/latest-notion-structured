...
import {
  type SchemaForgotPasswordValidation,
 ...
 */
const sendForgotPassworEmail = async (
  event: FormSubmitEvent<SchemaForgotPasswordValidation>
) => {
  try {
            ...
            >
              <div class="space-y-4">
                ...
                <p class="text-lg font-bold text-center">
                  Enter email that are registered on the platform
                </p>
