...
useSeoMeta({
  title: "Sign Up - Notion Structured",
});
...
const signUpWithCredential = async (
  event: FormSubmitEvent<SchemaSignUpValidation>
) => {
  try {
            ...
            >
              <div class="space-y-4">
                ...
                <p class="text-lg font-bold text-center">
                  Register an account by entering your email and password.
                </p>
